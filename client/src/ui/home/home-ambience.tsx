/**
 * HOME'S BACKDROP (2026-08-03, third brief) — "moving fog, very slow gradient
 * movement, ambient particles, soft drifting energy. Everything subtle."
 *
 * WHY IT IS A SEPARATE LAYER AND NOT A CHANGE TO ScreenShell. The shell's two
 ...
 * failure the ambient gate exists to prevent. This mounts on Home alone,
 * behind the ScrollView (so it never scrolls with the content), and holds
 * completely still the moment the tab loses focus.
 *
 * ONE DRIVER, 34 SECONDS. Two fog masses drift on a slow Lissajous (their x
 * and y periods are deliberately unequal, so the pair never repeats a path an
 ...
 * champion and their rating; the moment it is legible as an object it has
 * failed. It should only ever register as the page not being flat.
 */
