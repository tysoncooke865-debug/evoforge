...
export function WeeklyScheduleCard() {
  return (
    <Pressable
      ...
      style={{ gap: 12, minHeight: 56, borderColor: tokens.colors.border, backgroundColor: tokens.colors['surface-2'] }}
    >
      <View
        className="items-center justify-center rounded-md border"
        style={{ width: 36, height: 36, borderColor: `${tokens.colors.accent}45`, backgroundColor: 'rgba(34,211,238,0.07)' }}
      >
        <PixelCalendar size={16} color={tokens.colors.accent} />
      </View>
