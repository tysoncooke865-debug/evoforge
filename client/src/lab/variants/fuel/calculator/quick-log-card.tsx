/**
 * PAGE LAB — CALCULATOR copy of src/ui/fuel/quick-log-card.tsx (fork
 * recipe: copied because it WRITES; re-sync when the live file moves).
 * ONE change: `useLogCalories` comes from the lab shims, so LOG IT lands
 * in the seeded cache in mock mode instead of the real nutrition_log.
 */
import { useState } from 'react';
import { Text, TextInput, View } from 'react-native';

import { useLabLogCalories as useLogCalories } from '@/lab/mock/mutations';
