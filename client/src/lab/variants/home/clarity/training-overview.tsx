...
/**
 * CLARITY copy of ui/home/training-overview.tsx — same four metrics, legible
 * labels. Jersey 10 is drawn on a 10px grid, so the metric labels render at
 * 10, not 8, and every sub-12px label sits on text-dim (the AA tier) rather
 * than text-mute. The values were always the loud part; the labels only had
 * to stop being illegible.
 *
 ...
 *
 * Plain views, no chart library. The M–S pip row lives once, above the fold,
 * on the week strip; this card keeps the four NUMBERS.
 */
  ...
  return (
    ...
    >
      <View className="flex-row items-center justify-between">
        <Text className="text-2xs font-bold text-text-dim" style={{ letterSpacing: 2 }}>
          TRAINING OVERVIEW
        </Text>
