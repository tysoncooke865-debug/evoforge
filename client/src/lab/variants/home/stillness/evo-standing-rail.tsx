...
/**
 * STILLNESS COPY of ui/home/evo-standing-rail.tsx (Page Lab; rebuilt against
 * the current source 2026-08-21).
 *
 ...
 *
 * MOTION (STILLNESS): a gain gets ONE breath — a single swell to full glow
 * and back — and then the rail rests at its settled exposure. The page keeps
 * exactly two ambient movements (the champion's breath, the today pip), so
 * the rail's celebration is a one-shot here, like every other ceremony above
 * the fold.
 *
...
export function EvoStandingRail({ width }: { width?: number }) {
  ...
  // A GAIN GETS ONE BREATH, then rests — literally one, on the STILLNESS
  // budget: the swell runs its up-and-down once and the rail holds still.
