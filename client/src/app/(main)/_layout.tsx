...
export default function MainLayout() {
  ...
  return (
    <>
    <Tabs
      // detachInactiveScreens MUST STAY DEFAULT (true). Setting it false
      // (2026-07-18, chasing a page-change flash) BLENDED THE TABS on iOS 18
      // standalone: react-navigation kept every scene in the DOM but failed to
      // hide them — Tyson's screenshot showed Home's header + Train's day card
      // + Home's rating interleaved as one page. Reverted same day.
