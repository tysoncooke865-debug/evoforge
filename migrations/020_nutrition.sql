-- EvoForge 020 — FUEL: the nutrition tracker (nutrition branch; Claude, 2026-07-14).
--
-- WRITTEN ON THE BRANCH, APPLIED AT DEPLOYMENT. Additive and referenced by no
-- merged code, so applying it early (to test the branch against real Supabase)
-- is safe: the shipped app cannot reach these tables.
--
